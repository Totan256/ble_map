...
namespace Android.BLE.Commands
{
    ...
    public class DiscoverDevices : BleCommand
    {
        ...
        public DiscoverDevices(Action<string, string, int> onDeviceDiscovered, int discoverTime = StandardDiscoverTime) : base(true, false)
        {
        ...
        /// <param name="discoverTime">The amount of searching time in milliseconds that. Defaults to <see cref="StandardDiscoverTime"/>.</param>
        public DiscoverDevices(Action<string, string, int> onDeviceDiscovered, Action onFinishedDiscovering, int discoverTime = StandardDiscoverTime) : base(true, false)
        {
            OnDeviceDiscovered += new DeviceDiscovered(onDeviceDiscovered);
        ...
        public delegate void DeviceDiscovered(string deviceAddress, string deviceName, int rssi);
    }
}